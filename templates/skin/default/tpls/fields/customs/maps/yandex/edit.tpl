...
{literal}
		...
		{if $_aRequest.coord[$field_id][1] != ''}
			{literal}
			myPlacemark = new ymaps.Placemark([{/literal} {$_aRequest.coord[$field_id][0]} {literal}, {/literal} {$_aRequest.coord[$field_id][1]} {literal}]);
			myMap.geoObjects.add(myPlacemark);
			myMap.setCenter([{/literal} {$_aRequest.coord[$field_id][0]} {literal}, {/literal} {$_aRequest.coord[$field_id][1]} {literal}]);
			{/literal}
		{/if}
...
<input type="hidden" id="item_lat" name="fields[{$oField->getFieldId()}][0]" value="{$_aRequest.coord[$field_id][0]}"/>
<input type="hidden" id="item_lng" name="fields[{$oField->getFieldId()}][1]" value="{$_aRequest.coord[$field_id][1]}"/>
